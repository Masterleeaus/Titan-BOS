...
class ArticleReviewComplete extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        ...
        $this->headmessage = "Article review completed";
        $this->bodymessage = "completed reviewing the article.";
