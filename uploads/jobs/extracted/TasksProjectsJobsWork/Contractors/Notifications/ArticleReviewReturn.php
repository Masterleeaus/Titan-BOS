...
class ArticleReviewReturn extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        ...
        $this->headmessage = "Article review retured";
        $this->bodymessage = "returned the article for review again.";
