...
class ArticleWritingApprove extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        ...
        $this->headmessage = "Article has been approved";
        $this->bodymessage = "approved an article writing.";
