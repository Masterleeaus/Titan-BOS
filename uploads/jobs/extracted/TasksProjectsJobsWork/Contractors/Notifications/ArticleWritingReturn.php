...
class ArticleWritingReturn extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        ...
        $this->headmessage = "Article has been returned for revision";
        $this->bodymessage = "returned an article writing for revision.";
