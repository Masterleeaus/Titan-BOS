...
class NewArticleReview extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        ...
        $this->headmessage = "New reviewing article assigned";
        $this->bodymessage = "assigned a new article for review.";
